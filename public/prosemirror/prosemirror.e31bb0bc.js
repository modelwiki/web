...
function coordsAtPos(view, pos, side) {
  ...
  var $pos = view.state.doc.resolve(pos),
      inline = $pos.parent.inlineContent; // These browsers support querying empty text ranges. Prefer that in
  // bidi context.
  ...
  if (node.nodeType == 3) {
    if (side < 0) {
      return flattenV(singleRect(textRange(node, offset - 1, offset), 1), false);
    }
...
function selectVertically(view, dir, mods) {
  ...
  if (!$from.parent.inlineContent) {
    var beyond = _prosemirrorState.Selection.findFrom(dir < 0 ? $from : $to, dir);
...
function parseFromClipboard(view, text, html, plainText, $context) {
  ...
  if (asText) {
    ...
    if (inCode) {
      return new _prosemirrorModel.Slice(_prosemirrorModel.Fragment.from(view.state.schema.text(text)), 0, 0);
    }
...
},{"prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js","prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js","prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js"}],"node_modules/prosemirror-schema-basic/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
exports.schema = schema;
},{"prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js"}],"node_modules/prosemirror-schema-list/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js","prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js"}],"node_modules/w3c-keyname/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"w3c-keyname":"node_modules/w3c-keyname/index.es.js","prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js"}],"node_modules/rope-sequence/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"rope-sequence":"node_modules/rope-sequence/dist/index.es.js","prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js","prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js"}],"node_modules/prosemirror-commands/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js","prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js","prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js"}],"node_modules/prosemirror-dropcursor/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js","prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js"}],"node_modules/prosemirror-gapcursor/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/prosemirror-menu/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
exports.undoItem = exports.selectParentNodeItem = exports.redoItem = exports.liftItem = exports.joinUpItem = exports.icons = exports.MenuItem = exports.DropdownSubmenu = exports.Dropdown = void 0;
...
MenuItem.prototype.render = function render(view) {
  var spec = this.spec;
  var dom = spec.render ? spec.render(view) : spec.icon ? getIcon(spec.icon) : spec.label ? (0, _crelt.default)("div", null, translate(view, spec.label)) : null;
...
Dropdown.prototype.render = function render(view) {
  ...
  var label = (0, _crelt.default)("div", {
...
Dropdown.prototype.expand = function expand(dom, items) {
  var menuDOM = (0, _crelt.default)("div", {
...
function renderDropdownItems(items, view) {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    rendered.push((0, _crelt.default)("div", {
...
function renderGrouped(view, content) {
  ...
  for (var i = 0; i < content.length; i++) {
    ...
    for (var j = 0; j < items.length; j++) {
      ...
      var span = (0, _crelt.default)("span", {
        class: prefix$1 + "item"
      }, dom);
...
var joinUpItem = new MenuItem({
  ...
  select: function (state) {
    return (0, _prosemirrorCommands.joinUp)(state);
  },
  icon: icons.join
}); // :: MenuItem
...
var liftItem = new MenuItem({
  ...
  select: function (state) {
    return (0, _prosemirrorCommands.lift)(state);
  },
  icon: icons.lift
}); // :: MenuItem
...
var selectParentNodeItem = new MenuItem({
  ...
  run: _prosemirrorCommands.selectParentNode,
  select: function (state) {
    return (0, _prosemirrorCommands.selectParentNode)(state);
  },
...
var undoItem = new MenuItem({
  ...
  enable: function (state) {
    return (0, _prosemirrorHistory.undo)(state);
  },
  icon: icons.undo
}); // :: MenuItem
...
var redoItem = new MenuItem({
  ...
  enable: function (state) {
    return (0, _prosemirrorHistory.redo)(state);
  },
  icon: icons.redo
...
function wrapItem(nodeType, options) {
  var passedOptions = {
    run: function run(state, dispatch) {
      ...
      return (0, _prosemirrorCommands.wrapIn)(nodeType, options.attrs)(state, dispatch);
    },
    select: function select(state) {
      return (0, _prosemirrorCommands.wrapIn)(nodeType, options.attrs instanceof Function ? null : options.attrs)(state);
    }
  };
...
function blockTypeItem(nodeType, options) {
  var command = (0, _prosemirrorCommands.setBlockType)(nodeType, options.attrs);
  var passedOptions = {
    run: command,
...
var MenuBarView = function MenuBarView(editorView, options) {
  ...
  this.editorView = editorView;
  this.options = options;
  this.wrapper = (0, _crelt.default)("div", {
    class: prefix$2 + "-wrapper"
  });
  this.menu = this.wrapper.appendChild((0, _crelt.default)("div", {
    class: prefix$2
  }));
...
MenuBarView.prototype.updateFloat = function updateFloat(scrollAncestor) {
  ...
  if (this.floating) {
    ...
    if (editorRect.top < top && editorRect.bottom >= this.menu.offsetHeight + 10) {
      ...
      this.spacer = (0, _crelt.default)("div", {
...
},{"crelt":"node_modules/crelt/index.es.js","prosemirror-commands":"node_modules/prosemirror-commands/dist/index.es.js","prosemirror-history":"node_modules/prosemirror-history/dist/index.es.js","prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js"}],"node_modules/prosemirror-inputrules/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js","prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js"}],"node_modules/prosemirror-example-setup/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
function insertImageItem(nodeType) {
  return new _prosemirrorMenu.MenuItem({
    title: "Insert image",
    label: "Image",
    enable: function enable(state) {
    ...
    run: function run(state, _, view) {
      ...
      if (state.selection instanceof _prosemirrorState.NodeSelection && state.selection.node.type == nodeType) {
...
function linkItem(markType) {
  return new _prosemirrorMenu.MenuItem({
    ...
    icon: _prosemirrorMenu.icons.link,
    active: function active(state) {
      return markActive(state, markType);
    },
    enable: function enable(state) {
    ...
    run: function run(state, dispatch, view) {
      if (markActive(state, markType)) {
        (0, _prosemirrorCommands.toggleMark)(markType)(state, dispatch);
        return true;
      }
...
function buildMenuItems(schema) {
  ...
  if (type = schema.marks.strong) {
    r.toggleStrong = markItem(type, {
      ...
      icon: _prosemirrorMenu.icons.strong
    });
  }
  ...
  if (type = schema.marks.em) {
    r.toggleEm = markItem(type, {
      ...
      icon: _prosemirrorMenu.icons.em
    });
  }
  ...
  if (type = schema.marks.code) {
    r.toggleCode = markItem(type, {
      ...
      icon: _prosemirrorMenu.icons.code
    });
  }
  ...
  if (type = schema.nodes.blockquote) {
    r.wrapBlockQuote = (0, _prosemirrorMenu.wrapItem)(type, {
  ...
  if (type = schema.nodes.paragraph) {
    r.makeParagraph = (0, _prosemirrorMenu.blockTypeItem)(type, {
  ...
  if (type = schema.nodes.code_block) {
    r.makeCodeBlock = (0, _prosemirrorMenu.blockTypeItem)(type, {
  ...
  if (type = schema.nodes.horizontal_rule) {
    var hr = type;
    r.insertHorizontalRule = new _prosemirrorMenu.MenuItem({
  ...
  r.insertMenu = new _prosemirrorMenu.Dropdown(cut([r.insertImage, r.insertHorizontalRule]), {
    label: "Insert"
  });
  r.typeMenu = new _prosemirrorMenu.Dropdown(cut([r.makeParagraph, r.makeCodeBlock, r.makeHead1 && new _prosemirrorMenu.DropdownSubmenu(cut([r.makeHead1, r.makeHead2, r.makeHead3, r.makeHead4, r.makeHead5, r.makeHead6]), {
    label: "Heading"
  })]), {
    label: "Type..."
  });
  r.inlineMenu = [cut([r.toggleStrong, r.toggleEm, r.toggleCode, r.toggleLink])];
  r.blockMenu = [cut([r.wrapBulletList, r.wrapOrderedList, r.wrapBlockQuote, _prosemirrorMenu.joinUpItem, _prosemirrorMenu.liftItem, _prosemirrorMenu.selectParentNodeItem])];
  r.fullMenu = r.inlineMenu.concat([[r.insertMenu, r.typeMenu]], [[_prosemirrorMenu.undoItem, _prosemirrorMenu.redoItem]], r.blockMenu);
  return r;
}
...
function buildKeymap(schema, mapKeys) {
  ...
  if (!mac) {
    bind("Mod-y", _prosemirrorHistory.redo);
  }
  ...
  if (type = schema.marks.code) {
    bind("Mod-`", (0, _prosemirrorCommands.toggleMark)(type));
  }

  if (type = schema.nodes.bullet_list) {
    bind("Shift-Ctrl-8", (0, _prosemirrorSchemaList.wrapInList)(type));
  }

  if (type = schema.nodes.ordered_list) {
    bind("Shift-Ctrl-9", (0, _prosemirrorSchemaList.wrapInList)(type));
  }

  if (type = schema.nodes.blockquote) {
    bind("Ctrl->", (0, _prosemirrorCommands.wrapIn)(type));
  }
  ...
  if (type = schema.nodes.list_item) {
    bind("Enter", (0, _prosemirrorSchemaList.splitListItem)(type));
    bind("Mod-[", (0, _prosemirrorSchemaList.liftListItem)(type));
    bind("Mod-]", (0, _prosemirrorSchemaList.sinkListItem)(type));
  }

  if (type = schema.nodes.paragraph) {
    bind("Shift-Ctrl-0", (0, _prosemirrorCommands.setBlockType)(type));
  }

  if (type = schema.nodes.code_block) {
    bind("Shift-Ctrl-\\", (0, _prosemirrorCommands.setBlockType)(type));
  }
...
function exampleSetup(options) {
  var plugins = [buildInputRules(options.schema), (0, _prosemirrorKeymap.keymap)(buildKeymap(options.schema, options.mapKeys)), (0, _prosemirrorKeymap.keymap)(_prosemirrorCommands.baseKeymap), (0, _prosemirrorDropcursor.dropCursor)(), (0, _prosemirrorGapcursor.gapCursor)()];

  if (options.menuBar !== false) {
    plugins.push((0, _prosemirrorMenu.menuBar)({
  ...
  if (options.history !== false) {
    plugins.push((0, _prosemirrorHistory.history)());
  }

  return plugins.concat(new _prosemirrorState.Plugin({
    props: {
      attributes: {
...
},{"prosemirror-keymap":"node_modules/prosemirror-keymap/dist/index.es.js","prosemirror-history":"node_modules/prosemirror-history/dist/index.es.js","prosemirror-commands":"node_modules/prosemirror-commands/dist/index.es.js","prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js","prosemirror-dropcursor":"node_modules/prosemirror-dropcursor/dist/index.es.js","prosemirror-gapcursor":"node_modules/prosemirror-gapcursor/dist/index.es.js","prosemirror-menu":"node_modules/prosemirror-menu/dist/index.es.js","prosemirror-schema-list":"node_modules/prosemirror-schema-list/dist/index.es.js","prosemirror-inputrules":"node_modules/prosemirror-inputrules/dist/index.es.js"}],"variable-node.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.variableNodeSpec = void 0;
var variableValues = {
  1: "123 cats",
  2: "246 dogs"
};
var variableNodeSpec = {
  attrs: {
    variableId: {}
  },
  inline: true,
  ...
  parseDOM: [{
    ...
    getAttrs: function getAttrs(dom) {
      var variableId = dom.getAttribute("m-variable");
      return {
...
exports.variableNodeSpec = variableNodeSpec;
},{}],"variable-decoration.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.variablePlugin = void 0;
...
function variableDecoration(doc) {
  ...
  doc.descendants(function (node, pos) {
    if (node.type.name == "variable") {
      decos.push(_prosemirrorView.Decoration.widget(pos, variableElement(node.attrs.variableId)));
    }
  });
  return _prosemirrorView.DecorationSet.create(doc, decos);
}
...
var variablePlugin = new _prosemirrorState.Plugin({
  state: {
    init: function init(_, _ref) {
      var doc = _ref.doc;
      return variableDecoration(doc);
    },
    apply: function apply(tr, old) {
      return tr.docChanged ? variableDecoration(tr.doc) : old;
    }
  },
  props: {
...
exports.variablePlugin = variablePlugin;
},{"prosemirror-view":"node_modules/prosemirror-view/dist/index.es.js","prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _variableNode = require("./variable-node");

var _variableDecoration = require("./variable-decoration");

var listSchema = new _prosemirrorModel.Schema({
...
var mainSchema = new _prosemirrorModel.Schema({
  nodes: listSchema.spec.nodes.addBefore("image", "variable", _variableNode.variableNodeSpec),
  marks: listSchema.spec.marks
});
window.view = new _prosemirrorView.EditorView(document.querySelector("#editor"), {
  state: _prosemirrorState.EditorState.create({
    doc: _prosemirrorModel.DOMParser.fromSchema(mainSchema).parse(document.querySelector("#content")),
...
},{"prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js","prosemirror-view":"node_modules/prosemirror-view/dist/index.es.js","prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js","prosemirror-schema-basic":"node_modules/prosemirror-schema-basic/dist/index.es.js","prosemirror-schema-list":"node_modules/prosemirror-schema-list/dist/index.es.js","prosemirror-example-setup":"node_modules/prosemirror-example-setup/dist/index.es.js","./variable-node":"variable-node.js","./variable-decoration":"variable-decoration.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/prosemirror.e31bb0bc.js.map